...
class AzekarAlsabah extends StatefulWidget {
  const AzekarAlsabah({
    super.key,
  });

  @override
  State<AzekarAlsabah> createState() => _AzekarAlsabahState();
}

class _AzekarAlsabahState extends State<AzekarAlsabah> {
  @override
  Widget build(BuildContext context) {
    return Container(
      ...
      اللّهُ لاَ إِلَـهَ إِلاَّ هُوَ الْحَيُّ الْقَيُّومُ لاَ تَأْخُذُهُ سِنَةٌ وَلاَ نَوْمٌ لَّهُ مَا فِي السَّمَاوَاتِ وَمَا فِي الأَرْضِ مَن ذَا الَّذِي يَشْفَعُ عِنْدَهُ إِلاَّ بِإِذْنِهِ يَعْلَمُ مَا بَيْنَ أَيْدِيهِمْ وَمَا خَلْفَهُمْ وَلاَ يُحِيطُونَ بِشَيْءٍ مِّنْ عِلْمِهِ إِلاَّ بِمَا شَاء وَسِعَ كُرْسِيُّهُ السَّمَاوَاتِ وَالأَرْضَ وَلاَ يَؤُودُهُ حِفْظُهُمَا وَهُوَ الْعَلِيُّ الْعَظِيمُ. [آية الكرسى - البقرة 255]. ''',
            counter: counter[0],
            counterColor: color1[0],
            decrement: () => decrement1(0, setState),
          ),
          ZekrCard(
            zekr: '''بِسْمِ اللهِ الرَّحْمنِ الرَّحِيم
      قُلْ هُوَ ٱللَّهُ أَحَدٌ، ٱللَّهُ ٱلصَّمَدُ، لَمْ يَلِدْ وَلَمْ يُولَدْ، وَلَمْ يَكُن لَّهُۥ كُفُوًا أَحَدٌۢ. ''',
            counter: counter[1],
            counterColor: color1[1],
            decrement: () => decrement1(1, setState),
          ),
          ZekrCard(
            zekr: '''بِسْمِ اللهِ الرَّحْمنِ الرَّحِيم
      قُلْ أَعُوذُ بِرَبِّ ٱلْفَلَقِ، مِن شَرِّ مَا خَلَقَ، وَمِن شَرِّ غَاسِقٍ إِذَا وَقَبَ، وَمِن شَرِّ ٱلنَّفَّٰثَٰتِ فِى ٱلْعُقَدِ، وَمِن شَرِّ حَاسِدٍ إِذَا حَسَدَ. ''',
            counter: counter[2],
            counterColor: color1[2],
            decrement: () => decrement1(2, setState),
          ),
          ZekrCard(
            zekr: '''بِسْمِ اللهِ الرَّحْمنِ الرَّحِيم 
      قُلْ أَعُوذُ بِرَبِّ ٱلنَّاسِ، مَلِكِ ٱلنَّاسِ، إِلَٰهِ ٱلنَّاسِ، مِن شَرِّ ٱلْوَسْوَاسِ ٱلْخَنَّاسِ، ٱلَّذِى يُوَسْوِسُ فِى صُدُورِ ٱلنَّاسِ، مِنَ ٱلْجِنَّةِ وَٱلنَّاسِ. ''',
            counter: counter[3],
            counterColor: color1[3],
            decrement: () => decrement1(3, setState),
          ),
          ZekrCard(
            zekr:
                '''أَصْـبَحْنا وَأَصْـبَحَ المُـلْكُ لله وَالحَمدُ لله ، لا إلهَ إلاّ اللّهُ وَحدَهُ لا شَريكَ لهُ، لهُ المُـلكُ ولهُ الحَمْـد، وهُوَ على كلّ شَيءٍ قدير ، رَبِّ أسْـأَلُـكَ خَـيرَ ما في هـذا اليوم وَخَـيرَ ما بَعْـدَه ، وَأَعـوذُ بِكَ مِنْ شَـرِّ ما في هـذا اليوم وَشَرِّ ما بَعْـدَه، رَبِّ أَعـوذُبِكَ مِنَ الْكَسَـلِ وَسـوءِ الْكِـبَر ، رَبِّ أَعـوذُ بِكَ مِنْ عَـذابٍ في النّـارِ وَعَـذابٍ في القَـبْر. ''',
            counter: counter[4],
            counterColor: color1[4],
            decrement: () => decrement1(4, setState),
          ),
          ZekrCard(
            zekr:
                '''اللّهـمَّ أَنْتَ رَبِّـي لا إلهَ إلاّ أَنْتَ ، خَلَقْتَنـي وَأَنا عَبْـدُك ، وَأَنا عَلـى عَهْـدِكَ وَوَعْـدِكَ ما اسْتَـطَعْـت ، أَعـوذُبِكَ مِنْ شَـرِّ ما صَنَـعْت ، أَبـوءُ لَـكَ بِنِعْـمَتِـكَ عَلَـيَّ وَأَبـوءُ بِذَنْـبي فَاغْفـِرْ لي فَإِنَّـهُ لا يَغْـفِرُ الذُّنـوبَ إِلاّ أَنْتَ . ''',
            counter: counter[5],
            counterColor: color1[5],
            decrement: () => decrement1(5, setState),
          ),
          ZekrCard(
            zekr:
                '''رَضيـتُ بِاللهِ رَبَّـاً وَبِالإسْلامِ ديـناً وَبِمُحَـمَّدٍ صلى الله عليه وسلم نَبِيّـاً. ''',
            counter: counter[6],
            counterColor: color1[6],
            decrement: () => decrement1(6, setState),
          ),
          ZekrCard(
            zekr:
                '''اللّهُـمَّ إِنِّـي أَصْبَـحْتُ أُشْـهِدُك ، وَأُشْـهِدُ حَمَلَـةَ عَـرْشِـك ، وَمَلَائِكَتَكَ ، وَجَمـيعَ خَلْـقِك ، أَنَّـكَ أَنْـتَ اللهُ لا إلهَ إلاّ أَنْـتَ وَحْـدَكَ لا شَريكَ لَـك ، وَأَنَّ ُ مُحَمّـداً عَبْـدُكَ وَرَسـولُـك. ''',
            counter: counter[7],
            counterColor: color1[7],
            decrement: () => decrement1(7, setState),
          ),
          ZekrCard(
            zekr:
                '''اللّهُـمَّ إِنِّـي أَصْبَـحْتُ أُشْـهِدُك ، وَأُشْـهِدُ حَمَلَـةَ عَـرْشِـك ، وَمَلَائِكَتَكَ ، وَجَمـيعَ خَلْـقِك ، أَنَّـكَ أَنْـتَ اللهُ لا إلهَ إلاّ أَنْـتَ وَحْـدَكَ لا شَريكَ لَـك ، وَأَنَّ ُ مُحَمّـداً عَبْـدُكَ وَرَسـولُـك. ''',
            counter: counter[8],
            counterColor: color1[8],
            decrement: () => decrement1(8, setState),
          ),
          ZekrCard(
            zekr:
                '''حَسْبِـيَ اللّهُ لا إلهَ إلاّ هُوَ عَلَـيهِ تَوَكَّـلتُ وَهُوَ رَبُّ العَرْشِ العَظـيم. ''',
            counter: counter[9],
            counterColor: color1[9],
            decrement: () => decrement1(9, setState),
          ),
          ZekrCard(
            zekr:
                '''بِسـمِ اللهِ الذي لا يَضُـرُّ مَعَ اسمِـهِ شَيءٌ في الأرْضِ وَلا في السّمـاءِ وَهـوَ السّمـيعُ العَلـيم. ''',
            counter: counter[10],
            counterColor: color1[10],
            decrement: () => decrement1(10, setState),
          ),
          ZekrCard(
            zekr:
                '''اللّهُـمَّ بِكَ أَصْـبَحْنا وَبِكَ أَمْسَـينا ، وَبِكَ نَحْـيا وَبِكَ نَمُـوتُ وَإِلَـيْكَ النُّـشُور.''',
            counter: counter[11],
            counterColor: color1[11],
            decrement: () => decrement1(11, setState),
          ),
          ZekrCard(
            zekr:
          ...
          ZekrCard(
            ...
            counter: counter[18],
            counterColor: color1[18],
            decrement: () => decrement1(18, setState),
          ),
          ZekrCard(
            zekr:
            ...
            counter: counter[19],
            counterColor: color1[19],
            decrement: () => decrement1(19, setState),
          ),
          ZekrCard(
            zekr:
                '''أَعـوذُ بِكَلِمـاتِ اللّهِ التّـامّـاتِ مِنْ شَـرِّ ما خَلَـق. ''',
            counter: counter[20],
            counterColor: color1[20],
            decrement: () => decrement1(20, setState),
          ),
          ZekrCard(
            zekr:
                '''اللَّهُمَّ صَلِّ وَسَلِّمْ وَبَارِكْ على نَبِيِّنَا مُحمَّد. ''',
            counter: counter[21],
            counterColor: color1[21],
            decrement: () => decrement1(21, setState),
          ),
          ZekrCard(
            zekr:
                '''اللَّهُمَّ إِنَّا نَعُوذُ بِكَ مِنْ أَنْ نُشْرِكَ بِكَ شَيْئًا نَعْلَمُهُ ، وَنَسْتَغْفِرُكَ لِمَا لَا نَعْلَمُهُ.''',
            counter: counter[22],
            counterColor: color1[22],
            decrement: () => decrement1(22, setState),
          ),
          ZekrCard(
            zekr:
          ...
          ZekrCard(
            ...
            counter: counter[28],
            counterColor: color1[28],
            decrement: () => decrement1(28, setState),
          ),
          ZekrCard(
            zekr: '''سُبْحـانَ اللهِ وَبِحَمْـدِهِ. ''',
            counter: counter[29],
            counterColor: color1[29],
            decrement: () => decrement1(29, setState),
          ),
          ZekrCard(
            zekr: '''أسْتَغْفِرُ اللهَ وَأتُوبُ إلَيْهِ ''',
            counter: counter[30],
            counterColor: color1[30],
            decrement: () => decrement1(30, setState),
          ),
        ],
      ),
    );
